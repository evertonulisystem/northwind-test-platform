...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok && data.data?.token) {
        ...
        const errorMessage = Array.isArray(data.mensagens)
          ? data.mensagens[0]
          : data.mensagens;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 flex items-center justify-center px-4 py-6">
