...
export default function CartPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#0f172a] flex flex-col items-center justify-center text-white px-4 py-6">
        <Loader2 className="w-12 h-12 text-[#10b981] animate-spin mb-4" />
        <p className="text-slate-400 font-medium animate-pulse">
          Carregando seu carrinho premium...
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-white selection:bg-[#10b981]/30">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-6 md:px-6 md:py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {cartItems.map((item) => (
              ...
              >
                ...
                <div className="flex-grow text-center sm:text-left">
                  ...
                  <h3 className="text-xl font-bold mb-1 group-hover:text-[#10b981] transition">
                    {item.products.name}
                  </h3>
                  <p className="text-slate-400 text-sm mb-3">
                    Estoque disponível: {item.products.stock_quantity}
                  </p>
                ...
                <div className="text-center sm:text-right min-w-[120px]">
                  ...
                  <p className="text-slate-500 text-[10px] mt-1">
                    R$ {parseFloat(item.products.price).toFixed(2)} / un
                  </p>
                </div>
              </div>
            ))}
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-8">
            <div className="bg-slate-800/60 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-8 shadow-2xl relative overflow-hidden">
              ...
              <h2 className="text-2xl font-bold mb-8 border-b border-white/5 pb-4">
                Resumo
              </h2>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex justify-between text-slate-400 font-medium">
                  ...
                  <span
                    className={
                      shipping === 0 ? "text-[#10b981] font-bold" : "text-white"
                    }
                  >
                ...
                {shipping > 0 && (
                  <p className="text-[10px] text-[#10b981] bg-[#10b981]/5 p-3 rounded-xl border border-[#10b981]/10">
                    💡 Adicione mais{" "}
                    <strong>R$ {(200 - subtotal).toFixed(2)}</strong> para
