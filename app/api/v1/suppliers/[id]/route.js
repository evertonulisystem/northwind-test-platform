...
export async function PUT(request, { params }) {
  try {
    ...
    console.error('Erro no PUT suppliers:', error);
...
export async function DELETE(request, { params }) {
  try {
    ...
    console.error('Erro no DELETE suppliers:', error);
    ...
    if (error.message) {
      if (error.message.includes('violates foreign key constraint')) {
        if (error.message.includes('products')) {
          errorMessage = 'Não é possível excluir este fornecedor pois existem produtos vinculados a ele.';
        } else {
          errorMessage = 'Não é possível excluir este fornecedor pois existem dados vinculados a ele.';
        }
