...
// Forçar rebuild em produção
const forceRebuild = Date.now();
...
const options = {
  ...
  apis: [
    ...
    './app/api/v1/**/route.js',
    'app/api/v1/**/route.js',
    // Forçar inclusão específica dos endpoints PATCH
    './app/api/v1/products/[id]/route.js',
    './app/api/v1/categories/[id]/route.js',
    './app/api/v1/suppliers/[id]/route.js'
  ]
};
