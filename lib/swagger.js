  ...
  paths: {
    ...
    "/api/v1/products/search": {
      get: {
        ...
        description: "Busca direta por um dos parâmetros. Pelo menos um é obrigatório.",
        security: [{ bearerAuth: [] }],
        parameters: [
          ...
          "400": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
                  SemParametros: { value: { data: null, mensagens: ["Pelo menos um parâmetro deve ser fornecido: id, sku ou slug."] } },
