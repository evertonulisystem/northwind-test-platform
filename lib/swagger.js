  ...
  definition: {
    ...
    components: {
      schemas: {
        ...
        Product: {
          type: 'object',
          properties: {
            id: { type: 'integer', description: 'Identificador único do produto (gerado automaticamente)' },
            name: { 
              type: 'string', 
              minLength: 6, 
              maxLength: 40, 
              ...
              description: 'Nome completo do produto (obrigatório, 6-40 caracteres, sem números ou caracteres especiais, sem espaços duplicados, único)'
            },
            price: { 
              type: 'number', 
              minimum: 0.01, 
              ...
              multipleOf: 0.01,
              example: 299.90,
              description: 'Preço de venda do produto (obrigatório, valor > 0, máximo 999999.99, 2 casas decimais)'
            },
            stock_quantity: { 
              type: 'integer', 
              minimum: 0, 
              maximum: 999,
              example: 50,
              description: 'Quantidade em estoque (obrigatório, número inteiro, 0-999)'
            },
            sku: { 
              type: 'string', 
              minLength: 5, 
              ...
              pattern: '^[A-Z][A-Z0-9\\-]*$',
              example: 'MGP-2024W',
              description: 'SKU do produto (obrigatório, 5-20 caracteres, inicia com letra maiúscula, apenas letras maiúsculas, números e hífen, único)'
            },
            category_id: { 
              type: 'integer', 
              minimum: 1,
            ...
            slug: { 
              type: 'string', 
              example: 'mouse-gamer-rgb-pro-wireless',
              description: 'Slug gerado do nome do produto (gerado automaticamente)'
            },
            is_active: {
              type: 'boolean',
            ...
            created_at: {
              type: 'string',
              format: 'date-time',
              description: 'Data e hora de criação do produto (gerado automaticamente)'
            },
            categories: {
              type: 'object',
        ...
        ProductCreateRequest: {
          ...
          properties: {
            name: { 
              ...
              pattern: '^[a-zA-ZÀ-ÿ\\s]+$',
              example: 'Mouse Gamer RGB Pro Wireless',
              description: 'Nome completo do produto (obrigatório, 6-40 caracteres, sem números ou caracteres especiais, sem espaços duplicados)'
            },
            price: { 
              type: 'number', 
              minimum: 0.01, 
            ...
            sku: { 
              ...
              pattern: '^[A-Z][A-Z0-9\\-]*$',
              example: 'MGP-2024W',
              description: 'SKU do produto (obrigatório, 5-20 caracteres, inicia com letra maiúscula, apenas letras maiúsculas, números e hífen)'
            },
            category_id: { 
              type: 'integer', 
              minimum: 1,
        ...
        Supplier: {
          type: 'object',
          properties: {
            id: { type: 'integer', description: 'Identificador único do fornecedor (gerado automaticamente)' },
            company_name: { 
              type: 'string', 
              minLength: 3, 
              maxLength: 100, 
              example: 'Tech Solutions Ltda', 
              description: 'Razão social do fornecedor (obrigatório, 3-100 caracteres)' 
            },
            contact_name: { 
              type: 'string', 
              minLength: 5, 
              maxLength: 80, 
              example: 'João Silva', 
              description: 'Nome do contato do fornecedor (obrigatório, 5-80 caracteres)' 
            },
            email: { 
              type: 'string', 
              format: 'email', 
              example: 'joao@techsolutions.com', 
              description: 'E-mail do fornecedor (obrigatório, e-mail válido)' 
            },
            phone: { 
              type: 'string', 
              example: '(11) 98765-4321', 
              description: 'Telefone do fornecedor (obrigatório)' 
            },
            cnpj: { 
              type: 'string', 
              minLength: 14, 
              ...
              description: 'CNPJ do fornecedor (obrigatório, 14 dígitos)' 
            },
            uf: { 
              type: 'string', 
              minLength: 2, 
              ...
              pattern: '^[A-Z]{2}$',
              example: 'SP', 
              description: 'UF do fornecedor (obrigatório, 2 letras maiúsculas)' 
            },
          },
        },
        ...
        Category: {
          type: 'object',
          properties: {
            id: { type: 'integer', description: 'Identificador único da categoria (gerado automaticamente)' },
            name: { 
              type: 'string', 
              minLength: 3, 
              maxLength: 100, 
              example: 'Eletrônicos', 
              description: 'Nome da categoria (obrigatório, 3-100 caracteres, único)' 
            },
            description: { 
              type: 'string', 
              maxLength: 500, 
              example: 'Produtos eletrônicos variados', 
              description: 'Descrição da categoria (obrigatório, até 500 caracteres)' 
            },
            slug: { 
              type: 'string', 
              example: 'eletronicos', 
              description: 'Slug gerado do nome da categoria (gerado automaticamente)' 
            },
          },
        },
        ...
        Review: {
          type: 'object',
          properties: {
            id: { type: 'integer', description: 'Identificador único da avaliação' },
            product_id: { type: 'integer', description: 'ID do produto avaliado' },
            user_id: { type: 'string', description: 'ID do usuário que fez a avaliação' },
            rating: { type: 'integer', minimum: 1, maximum: 5, description: 'Nota de 1 a 5 estrelas' },
            title: { type: 'string', nullable: true, description: 'Título da avaliação' },
            comment: { type: 'string', description: 'Comentário da avaliação' },
            is_verified_purchase: { type: 'boolean', description: 'Se foi uma compra verificada' },
            helpful_count: { type: 'integer', description: 'Número de votos que indicaram a avaliação como útil' },
            is_approved: { type: 'boolean', description: 'Se a avaliação foi aprovada' },
            created_at: { type: 'string', format: 'date-time', description: 'Data de criação da avaliação' },
            products: {
              type: 'object',
              properties: {
                name: { type: 'string' }
              },
              description: 'Dados do produto avaliado'
            }
          }
        }
      },
        ...
        get: {
          ...
          parameters: [
            ...
            },
            {
              ...
              name: 'search',
              schema: { type: 'string' },
              description: 'Busca por nome, SKU ou slug do produto'
            },
            {
              in: 'query',
              name: 'category_id',
    ...
    responses: {
      ...
      '/api/v1/reviews': {
        get: {
          tags: ['Reviews'],
          summary: 'Lista avaliações aprovadas com paginação',
          security: [{ bearerAuth: [] }],
          parameters: [
            {
              in: 'query',
              name: 'product_id',
              schema: { type: 'integer' },
              description: 'Filtrar avaliações por ID do produto'
            },
            {
              in: 'query',
              name: 'page',
          ...
          responses: {
            200: {
              description: 'Lista paginada de avaliações aprovadas',
              content: {
                'application/json': {
                  schema: {
                    type: 'object',
