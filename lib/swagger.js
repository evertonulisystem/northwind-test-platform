// Categories: contrato publicado com exemplos gerados a partir dos schemas.
const { applyCategoriesDocumentation } = require("./openapi/categories");
...
const swaggerSpec = {
  ...
  tags: [
    ...
    { name: "Produtos", description: "CRUD, busca, validação, uploads e avaliações de produtos" },
  ...
  paths: {
        ...
        responses: {
                ...
                example: {
                  data: [
                    ...
                    },
                    {
                      id: 2,
                      name: "Teclado Mecânico Wireless",
                      slug: "teclado-mecanico-wireless",
                      price: 549.99,
                      stock_quantity: 37,
                      sku: "TCMW-2024B",
                      category_id: 1,
          ...
          "400": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
                  CampoOrdenacaoInvalido: { value: { data: null, mensagens: ["Campo de ordenação 'invalido' não é permitido. Use: id, name, price, stock_quantity, sku, created_at."] } },
                  OrdemInvalida: { value: { data: null, mensagens: ["Ordem 'invalido' não é permitida. Use: asc ou desc."] } }
                }
              }
            }
          },
          ...
          "404": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["Nenhum produto encontrado para os filtros aplicados."] }
              }
            }
          },
          "500": {
          ...
          "400": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
                  JsonInvalido: { value: { data: null, mensagens: ["Dados inválidos. Verifique se todos os campos foram preenchidos corretamente."] } },
                  NenhumDado: { value: { data: null, mensagens: ["Nenhum dado informado. Preencha os campos do produto."] } },
                  CamposAusentes: { value: { data: null, mensagens: ["Campos obrigatórios não preenchidos: name, price, stock_quantity."] } },
                  ...
                  CategoriaInexistente: { value: { data: null, mensagens: ["Categoria selecionada não existe. Escolha uma categoria válida."] } },
                  FornecedorInexistente: { value: { data: null, mensagens: ["Fornecedor selecionado não existe. Escolha um fornecedor válido."] } }
                }
              }
            }
          },
    ...
    "/api/v1/products/{id}": {
      get: {
        ...
        description: "Busca um produto pelo ID com categoria e fornecedor.",
        security: [{ bearerAuth: [] }],
        ...
        responses: {
          ...
          "400": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["ID do produto inválido. Deve ser um número positivo."] }
              }
            }
          },
          "401": { $ref: "#/components/responses/Unauthorized" },
          "404": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["Produto com ID 999 não encontrado."] }
              }
            }
          },
          "500": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["Erro interno ao buscar produto."] }
              }
            }
          }
        }
      ...
      put: {
        tags: ["Produtos"],
        summary: "Atualiza produto (PUT completo)",
        ...
        responses: {
            ...
            content: {
              "application/json": {
                example: {
                  data: {
                    id: 1,
                    name: "Mouse Gamer RGB Pro Wireless Atualizado",
                    slug: "mouse-gamer-rgb-pro-wireless-atualizado",
                    price: 329.90,
                    stock_quantity: 200,
                    sku: "MGP-2024W-UPD",
                    category_id: 1,
          ...
          "400": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
                  IdInvalido: { value: { data: null, mensagens: ["ID do produto inválido. Deve ser um número positivo."] } },
                  SkuObrigatorio: { value: { data: null, mensagens: ["SKU é obrigatório."] } },
                  PrecoInvalido: { value: { data: null, mensagens: ["O preço deve ser um valor positivo maior que zero."] } },
                  EstoqueInvalido: { value: { data: null, mensagens: ["A quantidade em estoque deve ser um número inteiro maior ou igual a zero."] } },
                  CategoriaInexistente: { value: { data: null, mensagens: ["Categoria selecionada não existe. Escolha uma categoria válida."] } },
                  FornecedorInexistente: { value: { data: null, mensagens: ["Fornecedor selecionado não existe. Escolha um fornecedor válido."] } }
          ...
          "409": {
            description: "Nome/slug ou SKU duplicado em outro produto",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
                  NomeDuplicado: { value: { data: null, mensagens: ["Já existe outro produto com esse nome/slug."] } },
                  SkuDuplicado: { value: { data: null, mensagens: ["Já existe outro produto com esse SKU."] } }
                }
              }
            }
          },
          "500": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["Erro ao atualizar produto."] }
              }
            }
          }
        }
      ...
      patch: {
        ...
        description: "Atualiza apenas os campos informados. Pelo menos um campo é obrigatório.",
        security: [{ bearerAuth: [] }],
        parameters: [{ in: "path", name: "id", required: true, schema: { type: "integer", example: 1 } }],
        requestBody: {
          required: true,
          content: {
            "application/json": {
              schema: {
                ...
                minProperties: 1,
                properties: {
                  name: { type: "string", minLength: 3, maxLength: 100, example: "Mouse Gamer RGB Pro Wireless" },
                  price: { type: "number", minimum: 0.01, example: 299.90 },
                  stock_quantity: { type: "integer", minimum: 0, example: 50 },
                  sku: { type: "string", example: "MGP-2024W" },
                  category_id: { type: "integer", minimum: 1, nullable: true, example: 1 },
                  supplier_id: { type: "integer", minimum: 1, nullable: true, example: 1 }
                }
              },
              example: { price: 259.90, stock_quantity: 180 }
            }
          }
        },
        responses: {
          ...
          "400": {
            ...
            content: {
              "application/json": {
                ...
                examples: {
                  IdInvalido: { value: { data: null, mensagens: ["ID do produto inválido. Deve ser um número positivo."] } },
                  NenhumCampo: { value: { data: null, mensagens: ["Pelo menos um campo deve ser fornecido para atualização."] } },
                  NomeVazio: { value: { data: null, mensagens: ["Nome não pode estar vazio."] } },
                  PrecoInvalido: { value: { data: null, mensagens: ["Preço deve ser um número positivo."] } },
                  EstoqueInvalido: { value: { data: null, mensagens: ["Quantidade em estoque deve ser um número inteiro positivo."] } },
                  SkuVazio: { value: { data: null, mensagens: ["SKU não pode estar vazio."] } },
                  CategoriaInvalida: { value: { data: null, mensagens: ["ID da categoria deve ser um número positivo ou nulo."] } },
                  FornecedorInvalido: { value: { data: null, mensagens: ["ID do fornecedor deve ser um número positivo ou nulo."] } }
                }
              }
            }
          },
          ...
          "409": {
            description: "Nome/slug ou SKU duplicado",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
      ...
      delete: {
        ...
        description: "Remove um produto do catálogo. Produtos vinculados a pedidos ou carrinho não podem ser excluídos.",
        security: [{ bearerAuth: [] }],
        parameters: [{ in: "path", name: "id", required: true, schema: { type: "integer", example: 1214 } }],
        responses: {
          "200": {
          ...
          "500": {
            description: "Erro interno ou violação de chave estrangeira",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["Não é possível excluir este produto pois existem pedidos ou itens no carrinho vinculados a ele."] }
              }
            }
          }
        }
    ...
    "/api/v1/products/search": {
      get: {
        tags: ["Produtos"],
        summary: "Busca produto por ID, SKU, slug ou nome",
        description: "Busca direta por um dos parâmetros. Pelo menos um é obrigatório. Se vários forem enviados, a prioridade é id, sku, slug e name. O nome deve ser completo e exato, incluindo maiúsculas e minúsculas; espaços nas extremidades são removidos.",
        security: [{ bearerAuth: [] }],
        parameters: [
          { in: "query", name: "id", schema: { type: "integer", example: 1 }, description: "ID do produto" },
          { in: "query", name: "sku", schema: { type: "string", example: "MGP-2024W" }, description: "SKU exato do produto" },
          { in: "query", name: "slug", schema: { type: "string", example: "mouse-gamer-rgb-pro-wireless" }, description: "Slug exato do produto" },
          { in: "query", name: "name", schema: { type: "string", example: "Mouse Gamer RGB Pro Wireless" }, description: "Nome completo e exato do produto" }
        ],
        responses: {
          "200": {
            description: "Produto encontrado",
          ...
          "400": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
                  SemParametros: { value: { data: null, mensagens: ["Pelo menos um parâmetro deve ser fornecido: id, sku, slug ou name."] } },
                  IdInvalido: { value: { data: null, mensagens: ["ID deve ser um número positivo válido."] } }
                }
              }
            }
          },
          ...
          "404": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["Produto não encontrado."] }
              }
            }
          },
          "500": {
    ...
    "/api/v1/products/validate": {
      post: {
        ...
        description: "Executa validações completas (campos obrigatórios, regras de negócio, duplicidades) e retorna erros, warnings e sugestões.",
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
        ...
        responses: {
          "200": {
            description: "Validação concluída (válida ou inválida — sempre 200)",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ProductValidationResponse" },
                examples: {
                  Valido: {
                    value: {
                      valid: true,
                      errors: [],
                      warnings: ["SKU em formato não padrão", "Nome deve começar com letra maiúscula"],
                      suggestions: ["Considere adicionar descrição detalhada", "Adicione informações de compatibilidade"],
                      message: "Produto válido para cadastro"
                    }
                  },
                  Invalido: {
                    value: {
                      valid: false,
                      errors: [
                        "Campos obrigatórios não preenchidos: name, price, stock_quantity, sku",
                        "Nome deve ter no mínimo 6 caracteres",
                        "Preço deve ser maior que zero",
                        "SKU já cadastrado no sistema"
                      ],
                      warnings: ["Categoria não informada, produto ficará sem categoria"],
                      suggestions: ["Adicione uma categoria para melhor organização"],
    ...
    "/api/v1/products/simulate-error": {
      get: {
        tags: ["Produtos"],
        summary: "Simula um erro interno 500 (para testes)",
        description: "Usado para validar tratamento de erro no cliente. Sempre retorna 500 se autenticado.",
        security: [{ bearerAuth: [] }],
        responses: {
          "401": { $ref: "#/components/responses/Unauthorized" },
          "500": {
            ...
            content: {
              "application/json": {
                ...
                example: {
                  data: null,
                  mensagens: ["Erro interno simulado: falha na conexão com o serviço de processamento de dados."]
                }
              }
            }
          }
    ...
    "/api/v1/products/storage/cleanup": {
      delete: {
        ...
        description: "Rota administrativa. Remove todos os arquivos (imagens e PDFs) do storage de produtos. Requer header x-admin-key.",
        parameters: [
          {
            in: "header",
            name: "x-admin-key",
            required: true,
            schema: { type: "string", example: "senha-secreta-do-everton" },
            description: "Chave secreta para autorizar a limpeza"
          }
        ],
        responses: {
          "200": {
          ...
          "403": {
            description: "Acesso negado — chave admin inválida",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: {
          ...
          "500": {
            description: "Erro interno ao limpar storage",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: {
    ...
    "/api/v1/products/{id}/reviews": {
      get: {
        tags: ["Produtos"],
        summary: "Lista avaliações aprovadas de um produto",
        description: "Retorna todas as avaliações aprovadas (is_approved=true) de um produto, com média de notas e contagem.",
        security: [{ bearerAuth: [] }],
        parameters: [{ in: "path", name: "id", required: true, schema: { type: "integer", example: 1 } }],
        responses: {
          "200": {
            description: "Lista de avaliações (mesmo que vazia)",
            content: {
              "application/json": {
                examples: {
                  ComAvaliacoes: {
                    value: {
                      data: [
                        ...
                        },
                        {
                          id: 2,
                          product_id: 1,
                          user_id: "b7fc1a2d-88a4-4e11-9c10-123456789abc",
                          rating: 4,
                          title: "Muito bom",
                          comment: "Custo benefício ótimo, só achei o clique um pouco alto.",
                          is_verified_purchase: true,
                          helpful_count: 5,
                          created_at: "2024-09-10T14:20:00.000Z"
                        }
                      ],
                      product: { id: 1, name: "Mouse Gamer RGB Pro Wireless" },
                      averageRating: 4.5,
                      totalReviews: 2,
                      mensagens: ["2 avaliação(ões) encontrada(s)."]
                    }
                  },
                  SemAvaliacoes: {
                    value: {
                      ...
                      averageRating: null,
                      totalReviews: 0,
                      mensagens: ["Este produto ainda não possui avaliações."]
                    }
                  }
                }
              }
          ...
          "400": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["ID do produto inválido."] }
              }
            }
          },
          "401": { $ref: "#/components/responses/Unauthorized" },
          ...
          "500": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["Erro interno ao buscar avaliações do produto."] }
              }
            }
          }
        }
    ...
    "/api/v1/products/{id}/image": {
      get: {
        tags: ["Produtos"],
        summary: "Lista imagens PNG do produto",
        description: "Retorna a lista de imagens associadas ao produto com seus IDs para download individual.",
        security: [{ bearerAuth: [] }],
        parameters: [{ in: "path", name: "id", required: true, schema: { type: "integer", example: 1 } }],
        responses: {
          "200": {
            ...
            content: {
              "application/json": {
                example: {
                  data: [
                    {
                      id: "f01afbb0-5c2a-4bac-9e8e-18877155de86",
                      filename: "f01afbb0-5c2a-4bac-9e8e-18877155de86_ChatGPT_Image.png",
                      url: "/api/v1/products/1/image/f01afbb0-5c2a-4bac-9e8e-18877155de86"
                    }
                  ],
                  mensagens: ["Lista de imagens recuperada com sucesso."]
                }
              }
            }
          },
          "500": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["Erro ao buscar imagens."] }
              }
            }
          }
        }
      ...
      post: {
        ...
        description: "Faz upload de uma imagem PNG para o produto. Valida formato e tamanho (máx. 2MB).",
        security: [{ bearerAuth: [] }],
        parameters: [{ in: "path", name: "id", required: true, schema: { type: "integer", example: 1 } }],
        requestBody: {
          required: true,
        ...
        responses: {
              ...
              "application/json": {
                example: {
                  data: {
                    ...
                    filename: "a1b2c3d4-5678-90ef-ghij-klmnopqrstuv_foto_produto.png",
                    size: 485760,
                    mimetype: "image/png",
                    productId: 1,
                    url: "/api/v1/products/1/image/a1b2c3d4-5678-90ef-ghij-klmnopqrstuv"
                  },
          ...
          "400": {
            description: "Arquivo inválido, ausente ou fora do limite",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                examples: {
                  IdInvalido: { value: { data: null, mensagens: ["ID do produto inválido."] } },
                  ArquivoAusente: { value: { data: null, mensagens: ["Nenhum arquivo enviado ou campo \"file\" ausente."] } },
                  FormatoInvalido: {
                    value: {
                      data: null,
                      mensagens: [
                  ...
                  ArquivoGrande: {
                    value: {
                      data: null,
                      mensagens: ["Arquivo muito grande. Tamanho máximo permitido: 2MB. Tamanho atual: 4.82MB"]
                    }
                  }
                }
              }
          ...
          "500": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["Erro interno ao processar upload."] }
              }
            }
          }
        }
    ...
    "/api/v1/products/{id}/pdf": {
      get: {
        tags: ["Produtos"],
        summary: "Lista PDFs do produto",
        description: "Retorna a lista de arquivos PDF (manuais, especificações) associados ao produto.",
        security: [{ bearerAuth: [] }],
        parameters: [{ in: "path", name: "id", required: true, schema: { type: "integer", example: 1 } }],
        responses: {
          "200": {
              ...
              "application/json": {
                example: {
                  data: [
                    {
                      id: "pdf-uuid-1234",
                      filename: "pdf-uuid-1234_manual_usuario.pdf",
                      url: "/api/v1/products/1/pdf/pdf-uuid-1234"
                    }
                  ],
                  mensagens: ["Lista de PDFs recuperada com sucesso."]
                }
              }
            }
          },
          "500": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/ErrorResponse" },
                example: { data: null, mensagens: ["Erro ao buscar PDFs."] }
              }
            }
          }
        }
      ...
      post: {
        ...
        description: "Faz upload de um PDF (manual, especificações, garantia) para o produto. Valida formato e tamanho (máx. 2MB).",
        security: [{ bearerAuth: [] }],
        parameters: [{ in: "path", name: "id", required: true, schema: { type: "integer", example: 1 } }],
        requestBody: {
          required: true,
            ...
            content: {
              "application/json": {
                example: {
                  data: {
                    id: "pdf-uuid-5678",
                    filename: "pdf-uuid-5678_manual_especificacoes.pdf",
                    size: 768000,
                    mimetype: "application/pdf",
                    productId: 1,
                    url: "/api/v1/products/1/pdf/pdf-uuid-5678"
                  },
            ...
            content: {
              "application/json": {
                ...
                examples: {
                  IdInvalido: { value: { data: null, mensagens: ["ID do produto inválido."] } },
                  ArquivoAusente: { value: { data: null, mensagens: ["Nenhum arquivo enviado ou campo \"file\" ausente."] } },
                  FormatoInvalido: { value: { data: null, mensagens: ["Apenas arquivos PDF são permitidos para documentos do produto."] } },
                  ArquivoGrande: {
                    value: {
                      data: null,
                      mensagens: ["Arquivo muito grande. Tamanho máximo permitido: 2MB. Tamanho atual: 3.10MB"]
                    }
                  }
                }
              }
...
applyCategoriesDocumentation(swaggerSpec);

require("./openapi/complete").completeDocumentation(swaggerSpec);
