...
const { applySuppliersDocumentation } = require('./suppliers');
const { applyProductsDocumentation } = require('./products');
...
function applyCategoriesDocumentation(spec) {
  ...
  applySuppliersDocumentation(spec);
  applyProductsDocumentation(spec);
}
