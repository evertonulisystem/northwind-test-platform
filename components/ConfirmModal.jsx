...
export default function ConfirmModal({ isOpen, message, onConfirm, onCancel }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4" data-testid="confirm-modal">
      <div className="bg-slate-800 text-white p-8 rounded-xl shadow-2xl max-w-sm w-full border border-slate-600">
        ...
        <p className="text-slate-300 mb-8 text-center text-lg leading-relaxed" data-testid="confirm-modal-message">
